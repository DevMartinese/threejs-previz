...
Copies of the reference material that ships inside `skills/`, gathered here for
reading outside Claude.

- `camera-moves.md` — the move catalog: every path with its `f(u)`, easing and
  duration, plus the Cinema Studio genre / speedramp mapping.
